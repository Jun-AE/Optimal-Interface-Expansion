...
num_sensors       = 2;        % NDP: 2 sensors ...
extra_excitations = 1;        % ... + (2+1) = 3 excitations  → 5 measured DoFs total
...
fprintf('\nBeam A: sensors %s | excitations %s | GCCM %.4f  (5 measured DoFs)\n', ...
    mat2str(res_a.sensor_dofs), mat2str(res_a.excitation_dofs), res_a.cor_overall);
fprintf('Beam B: sensors %s | excitations %s | GCCM %.4f  (5 measured DoFs)\n', ...
